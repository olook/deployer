...
class Deployer
  ...
  private 
    ...
    def notify_newrelic
      ...
      `curl -H "x-api-key:dbf7f72258b9cf5007eb859349cfd968104d69257fe4bb6" -d "deployment[user]=Rafael" -d "deployment[application_id]=476808" -d "deployment[revision]=#{revision}" https://api.newrelic.com/deployments.xml`
    end
